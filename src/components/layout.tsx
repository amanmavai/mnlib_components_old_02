...
export function Header({title, links, actionIcons}: HeaderProps) {
  return (
    <header className="tw-navbar bg-base-100 border-b border-b-gray-200">
      ...
      <div className="tw-navbar-end">
        {actionIcons || (
          <>
            <button className="tw-btn tw-btn-ghost tw-btn-circle">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="none"
            ...
            <button className="tw-btn tw-btn-ghost tw-btn-circle">
              <div className="tw-indicator">
                ...
                <span className="tw-badge tw-badge-xs tw-badge-primary tw-indicator-item"></span>
              </div>
            </button>
          </>
        )}
...
export function Footer() {
  return (
    <footer className="tw-footer items-center p-4 bg-neutral text-neutral-content">
      {/* <!-- Footer content --> */}
